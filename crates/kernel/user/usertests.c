// Replaced xv6's kernel/* includes with our consolidated user.h
// plus the kernel-side constants usertests probes. Our BSIZE
// differs from xv6 (512 vs 1024); tests that hardcode file-size
// expectations (`bigfile`) will fail until the disk format is
// reunified — that's tracked under G1+G3+G9 in the xv6-compat
// todo.
#include "user.h"
...
// Other kernel constants usertests reaches into.
#define MAXPATH     128
#define MAXARG      32
